                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                <form action="{{ route('user.post.login') }}" method="post">
                                                    ...
                                                    <button type="submit" class="btn btn-danger float-left btn-inline">Login</button>
                                                    <a href="{{ route('user.view.register') }}" class="btn btn-success float-right btn-inline">Register</a>
                                                </form>
                                            </div>
                                        </div>
